...
1. Follow the [Token documentation](/docs/System-Management/System-Configuration/Token) to create a GitHub token
...
Refer to the [Create a Storage Pool](/docs/Quick-Start/Create-Storage-Pool) guide to get started.
:::
