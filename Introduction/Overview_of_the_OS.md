...
Our new operating system **MOS** combines powerful features from storage management, containerization, and virtualization — all in a modern, easy-to-use platform.

# 🧱 Flexible Storage-Pools

Multiple drives can be combined into dynamic pools, even if they have different capacities. The system adapts to your hardware and gives you maximum flexibility when expanding your setup.
